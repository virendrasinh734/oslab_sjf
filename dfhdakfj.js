        ...
        if(in_r>0)
        {
            ...
            for(let j=0;j<readyQueue.length;j++){
                if(readyQueue[j][2]==min){
                    ...
                    completed.push(temp);
                    console.log(readyQueue[j]);
                    let ind=input.indexOf(readyQueue[j]);
                    console.log("ind is: "+ind);
                    input=input.splice(ind,1);
                    readyQueue=readyQueue.splice(j,1);
